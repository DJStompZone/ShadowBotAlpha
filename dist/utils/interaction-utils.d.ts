import { ApplicationCommandOptionChoiceData, AutocompleteInteraction, CommandInteraction, EmbedBuilder, InteractionReplyOptions, InteractionResponse, InteractionUpdateOptions, Message, MessageComponentInteraction, ModalSubmitInteraction, WebhookEditMessageOptions } from 'discord.js';
export declare class InteractionUtils {
    ...
    static editReply(intr: CommandInteraction | MessageComponentInteraction | ModalSubmitInteraction, content: string | EmbedBuilder | WebhookEditMessageOptions): Promise<Message>;
